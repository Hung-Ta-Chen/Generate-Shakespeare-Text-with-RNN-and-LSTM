...
def main():
  ...
  print(device)
  net = CharacterRNN(len(char_set), device = device, hidden_dim = 512).to(device)
  ...
  for epoch in range(1, epoch_num + 1):
    ...
    torch.save(net.state_dict(), 'rnn_net_{}.pt'.format(epoch))

  # Save parameters of the model
  torch.save(net.state_dict(), 'rnn_net_full.pt')
  """
  # Load the parameters of model
  net.load_state_dict(torch.load('rnn_net_full_h512.pt'))
